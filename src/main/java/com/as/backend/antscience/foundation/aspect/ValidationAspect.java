...
import com.as.backend.antscience.foundation.exception.InvalidParamsException;
...
public class ValidationAspect {
    ...
    @Before("@annotation(com.as.backend.antscience.foundation.aspect.ValidateParams)")
